...
export CFLAGS="-O2 -pipe -g  -pie -fPIE -D__ANDROID_API__=22 -DNON_VIRTAUL_CAN"
export LDFLAGS="-L$SDKTARGETSYSROOT/usr/lib -Wl,-O1 -Wl,--hash-style=sysv -Wl,--as-needed -lc"
